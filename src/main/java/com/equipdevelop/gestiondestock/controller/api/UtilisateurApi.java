...
import static com.equipdevelop.gestiondestock.utils.Constants.UTILISATEUR_ENDPOINT;
...
public interface UtilisateurApi {
  ...
  @GetMapping(UTILISATEUR_ENDPOINT + "/account")
  UtilisateurDto currentUser();

  @PostMapping(UTILISATEUR_ENDPOINT + "/update/password")
  UtilisateurDto changePassword(@RequestBody ChangerMotDePasseUtilisateurDto dto);
